<?php
$main_page = "Reports";
$page = "Non-Statutory MIS Report Details";
$excel_file_name = "Non_statutory_MIS";
                                ...
                                <div class="box">
                                    <div class="box-header">
                                        ...
                                        <h4 style="float: right;">
                                            ...
                                            <a href="report_management_mis.php">
                                    ...
                                    <div class="box-body">
                                        ...
                                        if (isset($_POST['search_mis_report'])) {
                                            ...
                                            if ($error_msg != "") {
                                                header("location:report_management_mis.php?error=$error_msg");
                                            } else {
                                                if (($department_id != "")) {
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                <th colspan="11" style="font-weight: bold; text-align: center;">
                                                                    MIS report - Status Report on Non-statutory Compliance 
                                                                    <?php
