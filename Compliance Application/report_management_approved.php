<?php
$main_page = "Reports";
$page = "Non-Statutory Compliance Approved Report";
                ...
                <div class="content-wrapper">
                    ...
                    <section class="content">
                        ...
                        <div class="box box-default">
                            <!-- /.box-header -->
                            <div class="box-body">
                                <form class="forms-sample" action="report_management_approved_details.php" method="post">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                                            ...
                                            <button type="submit" value="search" name="search_approved_report" id="search_approved_report" class="btn btn-primary mr-2" tabindex="17">
                                                Search</button> 
                                            <?php
                                            if ($_REQUEST['error']) {
                                                ?>
