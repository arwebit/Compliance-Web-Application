<?php
$main_page = "Reports";
$page = "Non-Statutory Compliance Status Report Details";
                                ...
                                <div class="box">
                                    <div class="box-header">
                                        ...
                                        <h4 style="float: right;"> 
                                            ...
                                            <a href="report_management_status.php">
                                    ...
                                    <div class="box-body">
                                        ...
                                        if (isset($_POST['search_status_report'])) {
                                            ...
                                            if ($error_msg != "") {
                                                header("location:report_management_status.php?error=$error_msg");
                                            } else {
                                                if (($department_id != "")) {
                                                ...
                                                <div style="height: 500px; overflow-x: scroll; overflow-y: scroll;">
                                                    <table id="tblData" class="table table-bordered">
                                                        <thead>
                                                            <tr>
                                                                <th colspan="18" style="font-weight: bold; text-align: center;">
                                                                    Status Report on Non-Statutory
                                                                    <?php
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $link = "mng_cmp_details.php?link=report_management_status.php&&mng_id=";
                                                            $slno = 0;
                                                            $status_reportSQL = "";
                                                            $status_reportSQL .= "SELECT a.id, a.mng_id, a.reference, b.location, c.department, a.description, a.due_date, a.renewed_date, ";
                                                            $status_reportSQL .= "a.assign_user, a.budgeted_cost, a.actual_transaction_value, a.comp_nature,a.status, a.update_status, ";
                                                            $status_reportSQL .= "a.create_date, a.modify_date, a.remarks FROM mng_cmp a INNER JOIN mas_location b ON a.location_id=b.id ";
                                                            $status_reportSQL .= "INNER JOIN mas_department c ON a.department_id=c.id WHERE a.company_id='$login_company_id' AND ";
                                                            $status_reportSQL .= "a.status!=-1 " . $where_clause . " ORDER BY a.status, a.mng_id";
