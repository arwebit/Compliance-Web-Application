<?php
$main_page = "Reports";
$page = "Non-Statutory Compliance User Report";
                ...
                <div class="content-wrapper">
                    ...
                    <section class="content">
                        ...
                        <div class="box box-default">
                            <!-- /.box-header -->
                            <div class="box-body">
                                <form class="forms-sample" action="report_user_non_statutory_details.php" method="post">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                                            ...
                                            <button type="submit" value="search" name="search_mis_report" id="search_mis_report" class="btn btn-primary mr-2" tabindex="17">
                                                Search</button> 
                                            <?php
                                            if ($_REQUEST['error']) {
                                                ?>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <label for="assign_person">User</label>
