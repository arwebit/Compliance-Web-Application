...
$page = "Statutory Compliance Assigner Task";
                            ...
                            <div class="col-xs-12">
                                <div class="box">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <table class="table table-bordered table-hover" id="stat_assgn_task">
                                            <thead>
                                                <tr>
                                                    <th ><b>SC ID</b></th>
                                                    <th syle="font-weight:bolder;"><b>Activity</b></th>
                                                    <th syle="font-weight:bolder;"><b>Mode</b></th>
                                                    <th syle="font-weight:bolder;"><b>Legislation</b></th>
                                            ...
                                            if (isset($_REQUEST['search_task'])) {
                                                ...
                                                <tbody>
                                                    <?php
                                                    $rm_SQL = "";
                                                    $rm_SQL .= "SELECT a.id, a.due_date, b.activity, a.rm_id, a.status, a.update_status, c.mode, d.short_legislation as legislation, e.location FROM risk_management a INNER JOIN  ";
                                                    $rm_SQL .= "mas_activity b ON a.activity_id=b.id INNER JOIN mas_mode c ON a.mode_id=c.id INNER JOIN mas_legislation d ON a.legislation_id=d.id INNER JOIN mas_location ";
                                                    $rm_SQL .= "e ON e.id=a.location_id WHERE a.assign_user='$login_user' AND a.update_status!=1 AND a.company_id='$login_company_id' " . $where_clause;

                                                    $fetch_rm = json_decode(ret_json_str($rm_SQL));
                                                    foreach ($fetch_rm as $fetch_rms) {
                                                        $update_status = $fetch_rms->update_status;
                                                        $status = $fetch_rms->status;
                                                       ...
                                                       if ($days_pending_due >= 0) {
                                                        ...
                                                        <tr style="<?php echo $bgColor; ?>">
                                                            ...
                                                            <td><?php echo $fetch_rms->activity; ?></td>
                                                            <td><?php echo $fetch_rms->mode; ?></td>
                                                            <td><?php echo $fetch_rms->legislation; ?></td>
                                                            <td><?php echo $fetch_rms->location; ?></td>
                                                            ...
                                                            <td>
                                                                <a href="risk_management_details.php?link=assigner_tasks.php&&rm_id=<?php echo $fetch_rms->id; ?>" class="btn btn-warning">
                                                                    DETAILS  
                                                                </a> ||
                                                                <?php
                                                                if (!(($status == 1) && ($update_status == 1))) {
                                                                    if ($update_status != 3) {
                                                                        ?>
                                                                        <a href="mark_complete_rm.php?rm_id=<?php echo $fetch_rms->id; ?>" class="btn btn-info">
                                                                            MARK COMPLETE  
                                                                        </a>
                                                                        <?php
                                                                    } else {
